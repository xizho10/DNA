...
var (
	OpExecList = [256]OpExec{
		...
		PUSH1:       {PUSH1, "PUSH1", opPushData},
		PUSH2:       {PUSH2, "PUSH2", opPushData},
		PUSH3:       {PUSH3, "PUSH3", opPushData},
		PUSH4:       {PUSH4, "PUSH4", opPushData},
		PUSH5:       {PUSH5, "PUSH5", opPushData},
		PUSH6:       {PUSH6, "PUSH6", opPushData},
		PUSH7:       {PUSH7, "PUSH7", opPushData},
		PUSH8:       {PUSH8, "PUSH8", opPushData},
		PUSH9:       {PUSH9, "PUSH9", opPushData},
		PUSH10:      {PUSH10, "PUSH10", opPushData},
		PUSH11:      {PUSH11, "PUSH11", opPushData},
		PUSH12:      {PUSH12, "PUSH12", opPushData},
		PUSH13:      {PUSH13, "PUSH13", opPushData},
		PUSH14:      {PUSH14, "PUSH14", opPushData},
		PUSH15:      {PUSH15, "PUSH15", opPushData},
		PUSH16:      {PUSH16, "PUSH16", opPushData},
